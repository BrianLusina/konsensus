...
from konsensus.entities.messages_types import Accept, Accepted, Decision, Decided, Preempted
from konsensus.entities.data_types import Proposal, Ballot


class CommanderTestCases(BaseTestCase):
    def setUp(self):
        super().setUp()
        self.cb_args = None
        self.slot = 10
        ...
        self.cmd = Commander(
            self.node, ballot_num=self.ballot_num, slot=self.slot, proposal=self.proposal, peers=["p1", "p2", "p3"]
        )
